  ...
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="page.php">Politics </a></li>
          <li><a href="another_page.php">Sports</a></li>
    ...
    <div id="site_content">
      <div class="sidebar">
        ...
        <h3>Latest News</h3>
        <h4>New Trending News</h4>
        <h5>January 1st, 2010</h5>
        <p>See the news here.<br /><a href="#">Read more</a></p>
        <p></p>
        <h4>New Trending News</h4>
        <h5>January 1st, 2010</h5>
        <p>See the news here<br /><a href="#">Read more</a></p>
      ...
      <div id="content">
        ...
        <!-- <h1>A Page</h1>
        <p>ndjdddbdub djx x nnanajsiwh wjbwudbwubw wubwisuwbdbwudbwudbwbdwudbwiudbwuidbw wjbwubwuidbwbwubwubwubwwbw  wubhuwdwubduwuwbd dwudbwudbwiwnmamamanaanjaamaabababajbaj.</p>
        <p>ndjdddbdub djx x nnanajsiwh wjbwudbwubw wubwisuwbdbwudbwudbwbdwudbwiudbwuidbw wjbwubwuidbwbwubwubwubwwbw  wubhuwdwubduwuwbd dwudbwudbwiwnmamamanaanjaamaabababajbaj.</p>
        <p>ndjdddbdub djx x nnanajsiwh wjbwudbwubw wubwisuwbdbwudbwudbwbdwudbwiudbwuidbw wjbwubwuidbwbwubwubwubwwbw  wubhuwdwubduwuwbd dwudbwudbwiwnmamamanaanjaamaabababajbaj.</p>
        <p>ndjdddbdub djx x nnanajsiwh wjbwudbwubw wubwisuwbdbwudbwudbwbdwudbwiudbwuidbw wjbwubwuidbwbwubwubwubwwbw  wubhuwdwubduwuwbd dwudbwudbwiwnmamamanaanjaamaabababajbaj.</p>
        <p>ndjdddbdub djx x nnanajsiwh wjbwudbwubw wubwisuwbdbwudbwudbwbdwudbwiudbwuidbw wjbwubwuidbwbwubwubwubwwbw  wubhuwdwubduwuwbd dwudbwudbwiwnmamamanaanjaamaabababajbaj.</p>
    ...
    <div id="footer">
      Copyright &copy; BOOST | <a href="">Sports</a> | <a href="">Politics</a> | <a href="">Technologies</a>
    </div>
  </div>
 ...
 <script  src="./jquery-3.2.1.min.js"></script>
  ...
  <script>
      $(document).ready(function(){
        $.ajax(
        {
            url: "https://newsapi.org/v2/top-headlines?sources=politico&apiKey=1c0136b9c55641e5a28546c1a97226e1",
            ...
            success:function(res){
                ...
                var article = res.articles;
                 ...
                 console.log(article[4].publishedAt);
                 ...
                 // document.getElementById('ur[5]').innerHTML=article[5].url;
